...
void CCurl::deleteRequest(const std::string &url, const std::list<std::string> &headers,
			  long &respCode)
{
	struct curl_slist *slist = nullptr;
...
void CCurl::patchRequest(const std::string &url, const std::list<std::string> &headers,
